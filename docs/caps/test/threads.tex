...
\begin{table}[H]
   \centering
   \includegraphics[width=1\textwidth]{images/tables/threads2_time.png}
...
\begin{table}[H]
   \centering
   \includegraphics[width=1\textwidth]{images/tables/threads4_time.png}
   \caption{Resultados del algoritmo paralelizado con hilos}
   \label{tab:threads4}
\end{table}
...
\begin{table}[H]
   \centering
   \includegraphics[width=1\textwidth]{images/tables/threads6_time.png}
   \caption{Resultados del algoritmo paralelizado con hilos}
   \label{tab:threads6}
\end{table}
...
\begin{table}[H]
   \centering
   \includegraphics[width=1\textwidth]{images/tables/threads8_time.png}
   \caption{Resultados del algoritmo paralelizado con hilos}
   \label{tab:threads8}
\end{table}
...
\begin{table}[H]
   \centering
   \includegraphics[width=1\textwidth]{images/tables/threads12_time.png}
   \caption{Resultados del algoritmo paralelizado con hilos}
   \label{tab:threads12}
\end{table}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=1\textwidth]{images/charts/threads_time.png}
   \caption{Comparación del tiempo de ejecución entre el algoritmo secuencial y el algoritmo paralelizado con hilos}
   \label{fig:chart_threads_time}
\end{figure}
